...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 25 2025 г., 01:15
...
(1, 'Липина', 'Кристина', 'Александровна', 'lipina', 'Asdfg123');
...
CREATE TABLE `Zaniyatie` (
  `Id` int NOT NULL,
  `ZaniyatieName` varchar(255) NOT NULL,
  `MinutesMissed` int NOT NULL,
  `Obyasnitelnaya` longblob
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
ALTER TABLE `Consultations`
  MODIFY `ConsultationID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `DisciplinePrograms`
--
ALTER TABLE `DisciplinePrograms`
  MODIFY `ProgramID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `Disciplines`
--
ALTER TABLE `Disciplines`
  MODIFY `DisciplineID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `InstructorLoads`
  MODIFY `LoadID` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `Instructors`
--
ALTER TABLE `Instructors`
  MODIFY `InstructorID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
